...
class _JobArticleState extends State<JobArticle> {
  /*
   * 
    ...
    if (_valid()) {
      ...
      if (responseJson == null) {
        ...
        Navigator.of(_scaffoldKey.currentContext).pushReplacement(
          ...
          return new JobArticle(postId: widget.postId);
        }));
      }
      _hideLoading();
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        key: _scaffoldKey,
        body: _isLoading ? _loadingScreen() : _jobArticleScreen());
  }
