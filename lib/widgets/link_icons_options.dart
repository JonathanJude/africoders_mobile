...
class LinksIconOptions extends StatefulWidget {
  ...
  @override
  LinksIconOptionsState createState() {
    return new LinksIconOptionsState();
  }
}
...
//TODO: CONTINUE FROM HERE
  ...
  //Edit Post Dialog
  void displayEditDialog(GlobalKey scaffoldKey, String text, String title,
      String url, int postId) {
    ...
    _onEditPost() async {
      _showLoading();
      if (_valid()) {
        var responseJson = await PostUtils.updateLink(postId.toString(),
            titleController.text, bodyController.text, urlController.text);
    ...
    return Row(
      ...
      children: <Widget>[
        IconButton(
          ...
          onPressed: () {
            displayEditDialog(scaffoldKey, widget.body, widget.title,
                widget.url, widget.postId);
          },
