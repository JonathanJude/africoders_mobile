...
class StatusHomeDrawer extends StatefulWidget {
  @override
  StatusHomeDrawerState createState() {
    return new StatusHomeDrawerState();
  }
}

class StatusHomeDrawerState extends State<StatusHomeDrawer> {
  @override
